...
function reverie_theme_support() {
	...
	register_nav_menus(array(
		...
		'subservices' => __('Subnavigation for Services Section', 'reverie'),
		'footercompany' => __('Footer - Company Navigation', 'reverie'),
		'footerservices' => __('Footer - Services Navigation', 'reverie'),
		'footertechnology' => __('Footer - Technology Navigation', 'reverie'),
		'footerlegal' => __('Footer - Legal Navigation', 'reverie')
	));
